...
XELAB_1="C:/Users/Janier Arias Garcia/Documents/Projeto_Caio/project_AES/project_AES.sim/sim_1/behav/AES_BT_TB.prj"

ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot AES_BT_TB_behav --prj "$XELAB_1"   xil_defaultlib.AES_BT_TB
