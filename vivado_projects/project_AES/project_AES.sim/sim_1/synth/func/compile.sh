...
XELAB_1="C:/Users/Janier Arias Garcia/Documents/Projeto Caio/project_AES/project_AES.sim/sim_1/synth/func/AES_TB.prj"

ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot AES_TB_func_synth --prj "$XELAB_1"   xil_defaultlib.AES_TB
